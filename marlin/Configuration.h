...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  24.01 //21.01//28.72
    #define DEFAULT_Ki  2.19 //1.82 //2.62
    #define DEFAULT_Kd  65.07 //60.56 //78.81
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 204.06 //209.19
  #define DEFAULT_bedKi 40.49 //39.54
  #define DEFAULT_bedKd 685.65 //737.81
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 386.4 }//E94.5
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 800, 800, 100, 500 }
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_Z_HOP       0.3 //4  // (mm) Z height of nozzle between leveling points
...
#define PREHEAT_3_FAN_SPEED   153 // Value from 0 to 255

#define PREHEAT_4_LABEL       "PET" 
#define PREHEAT_4_TEMP_HOTEND 265
#define PREHEAT_4_TEMP_BED    80
#define PREHEAT_4_TEMP_CHAMBER 35
#define PREHEAT_4_FAN_SPEED   125 // Value from 0 to 255
