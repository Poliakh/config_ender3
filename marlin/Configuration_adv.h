...
// #define E0_AUTO_FAN_PIN P2_04//это отключил
#define E0_AUTO_FAN_PIN FAN1_PIN // Cold-end fan to E1 heater
#define EXTRUDER_AUTO_FAN_TEMPERATURE 50
#define EXTRUDER_AUTO_FAN_SPEED 255   // 255 == full speed
//end подключение вентилятора вместо хотенда
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE {100*60, 100*60, 10*60, 2*60}// { 50*60, 50*60, 4*60, 2*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
// #define BEEP_ON_FEEDRATE_CHANGE
  ...
  // #define LCD_SHOW_E_TOTAL // ОТОБРАЖЕНИЕ ДЛИНЫ ИСПОЛЬЗОВАННОГО ПЛАСТИКА ПРИ ПЕЧАТИ
#endif

#if EITHER(SDSUPPORT, LCD_SET_PROGRESS_MANUALLY) && ANY(HAS_MARLINUI_U8GLIB, HAS_MARLINUI_HD44780, IS_TFTGLCD_PANEL, EXTENSIBLE_UI)
  #define SHOW_REMAINING_TIME       // Display estimated time to completion время до окончания печати
   ...
   * point in the file.
   */
  // #define POWER_LOSS_RECOVERY//восстановление печати
   ...
   */
  #define SDCARD_CONNECTION ONBOARD //#define SDCARD_CONNECTION LCD_AND_ONBOARD //- видит принтер как флешку, но проблема с запуском печати с флекши.
 ...
 * Override the default value based on the driver type set in Configuration.h.
 */
#define MINIMUM_STEPPER_PULSE 2//4
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      449  // (mm) The length of filament for a complete unload.
